...
A quick start Blazor project that shows how to group nodes and connectors in a [Blazor Diagram](https://www.syncfusion.com/diagram-sdk/blazor-diagram). This project includes a code snippet to create and update group dynamically. It also includes a code snippet to add annotations to the group and create a nested group.
